...
const missionSets = {
  "서성준": ["최민규가 저글링하는 모습 찍기", "초점없는 눈의 한은혜 찍기", "이다경이 뛰어다니는 순간 찍기", "김학진이 놀라는 순간 찍기", "아무도 카메라를 보고 있지 않은 단체사진 찍기"],
  "최민규": ["한은혜가 농구하는 모습 찍기", "이다경이 고기를 먹기 직전의 순간 찍기", "김학진의 두 발이 땅에서 떨어진 모습 찍기", "김학진, 은태경, 이은비만 나오도록 사진 찍기", "불 피우는 사람과 아무것도 하지 않는 사람이 한 프레임에 나오게 찍기"],
  "한은혜": ["이다경만 카메라를 바라보고 있는 단체 항공샷 찍기", "이은비와 김학진이 서로 장난치는 순간 찍기", "은태경이 누군가를 안고 있는 사진 찍기", "최민규가 방망이를 휘두르고 있는 사진 찍기", "두명 이상이 똑같은 자세나 포즈를 하고 있는 순간 찍기"],
  "이다경": ["김학진만 다른 포즈를 하고 있는 모두가 나오는 단체사진 찍기", "은태경이 양손으로 브이하고 있는 사진 찍기", "이은비가 무거운 무거운 물건 옮기는 사진 찍기", "공을 차고 있는 서성준 모습 찍기", "최민규를 포함하여 세명 이상 거울 등에 비친 모습 찍기"],
  "김학진": ["사람들 사이에서 은태경이 멍때리고 있는 사진 찍기", "이은비가 화장 고치고 있는 모습 찍기", "서성준이 가위바위보 하는 모습 찍기", "최민규를 주먹으로 때리고 있는 한은혜 모습 찍기", "누군가를 찍고 있는 모습을 뒤에서 찍기"],
  "은태경": ["이은비가 주먹을 쥐고 휘두르려는 사진 찍기", "서성준이 최민규와 함께 저글링하고 있는 모습 찍기", "김학진이 한 팔만 들고 있는 모습 찍기", "이다경이 누군가와 손잡고 있는 모습 찍기", "초점없는 눈의 한은혜 찍기"],
  "이은비": ["서성준이 징징대는 모습 찍기", "최민규가 한은혜 이마를 때리는 모습 찍기", "한은혜 양손에 물건을 들고 있는 사진 찍기", "이다경이 두 팔을 벌린 모습 찍기", "김학진을 포함한 세명 이상 누워있는 장면 찍기"]
};
