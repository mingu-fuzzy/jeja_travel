...
const missionSets = {
  ...
  "최민규": ["한은혜가 동생 괴롭히는 장면 찍기", "이다경이 고기를 먹기 직전의 순간 찍기", "김학진의 두 발이 땅에서 떨어진 모습 찍기", "김학진, 은태경, 이은비만 나오도록 사진 찍기", "불 피우는 사람과 아무것도 하지 않는 사람이 한 프레임에 나오게 찍기"],
  ...
  "김학진": ["사람들 사이에서 은태경이 멍때리고 있는 사진 찍기", "이은비가 화장 고치고 있는 모습 찍기", "서성준이 가위바위보 하는 모습 찍기", "박장대소중인 한은혜 모습 찍기", "누군가를 찍고 있는 모습을 뒤에서 찍기"],
