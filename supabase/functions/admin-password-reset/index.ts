...
const memberEmails: Record<string, string> = {
  "서성준":"seongjun@jeja.local", "최민규":"mingyu@jeja.local", "한은혜":"eunhye@jeja.local",
  "이다경":"dagyeong@jeja.local", "김학진":"hakjin@jeja.local", "은태경":"taegyeong@jeja.local", "이은비":"eunbi@jeja.local",
};
